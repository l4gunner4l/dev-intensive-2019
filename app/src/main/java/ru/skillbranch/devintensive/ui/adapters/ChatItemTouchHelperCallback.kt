...
class ChatItemTouchHelperCallback(
    ...
    override fun getMovementFlags(
        ...
        return if (viewHolder is ItemTouchViewHolder) makeFlag(ItemTouchHelper.ACTION_STATE_SWIPE, ItemTouchHelper.START)
    ...
    private fun drawBg(canvas: Canvas, itemView: View, dX: Float) {
        with(bgRect){
